...
CREATE TABLE `users` (
  ...
  `specialties` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT '[]' CHECK (json_valid(`specialties`)),
  `interests` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT '[]' CHECK (json_valid(`interests`)),
...
ALTER TABLE `user_votes`
  ...
  ADD KEY `user_votes_article_id_foreign` (`article_id`);
...
--
ALTER TABLE `user_votes`
  ADD CONSTRAINT `user_votes_article_id_foreign` FOREIGN KEY (`article_id`) REFERENCES `articles` (`id`) ON DELETE CASCADE,
